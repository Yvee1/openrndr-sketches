...
//    val p = listOf(1.0 v2 0.0, 1.5 v2 0.3, 2.0 v2 1.0, 3.0 v2 0.5, 4.0 v2 -1.0, 5.0 v2 0.0)
    ...
    application {
        ...
        program {
            ...
            fun drawMapping(mapping: List<Pair<Int, Int>>, p: List<Vector2>, q: List<Vector2>){
                drawer.apply {
            ...
            val viridis = Viridis()
            fun drawDPTable(table: Array<Array<Double>>, pos: Vector2, size: Double, mapping: List<Pair<Int, Int>>? = null){
                val n = table.size
                val m = table[0].size
...
//                            fill = ColorRGBa.BLACK.opacify(1-t)
                ...
                drawer.isolated {
                    ...
                    mapping?.let {
                        ...
                        lineStrip(it.map { pair -> Vector2((pair.second+0.5)  * cellSize, (pair.first+0.5) * cellSize) })
                    }
                }
            }
...
//                    translate(-2.5, 0.0)
                    ...
                    drawDPTable(gamma, Vector2(-5.0, -2.0), 5.0, mapping)
